...
use syncplay_client_app::app_boundary::{
    persistence::update_syncplay_ini_stored_client_settings_mvp_at_path,
    state::StoredClientSettingsMvp,
};

use crate::client_args::LegacyClientArgOverrides;
use crate::config_paths::resolve_syncplay_cli_config_path_legacy_compatible;
...
pub(super) fn persist_syncplay_cli_last_checked_for_updates_setting_legacy_compatible(
    timestamp: &str,
) -> anyhow::Result<()> {
