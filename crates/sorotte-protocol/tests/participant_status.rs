...
fn availability_is_report_derived(value: ParticipantStatusAvailability) -> bool {
    matches!(
        value,
...
#[test]
fn view_sanitizer_exposes_offsets_only_for_exact_correlation() {
...
#[test]
fn participant_status_builders_round_trip_scoped_reports() {
    ...
    assert!(availability_is_report_derived(
        decoded
            .snapshot
            .expect("snapshot")
            .participants
