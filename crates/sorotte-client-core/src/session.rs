...
pub struct ClientSession {
    ...
    server_media_match_supported: Option<bool>,
    ...
    reconnect_file_restore_snapshot: Option<FilePayload>,
    reconnect_file_restore_intent: Option<FilePayload>,
...
impl Default for ClientSession {
    fn default() -> Self {
        ...
        Self {
            ...
            server_media_match_supported: None,
