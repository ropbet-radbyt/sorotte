...
pub struct StoredClientSettings {
...
impl fmt::Debug for StoredClientSettings {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("StoredClientSettings")
...
pub fn privacy_mode_syncplay_name(mode: PrivacyMode) -> &'static str {
    match mode {
...
pub fn unpause_action_mode_syncplay_name(mode: UnpauseActionMode) -> &'static str {
    match mode {
...
pub fn autoplay_threshold_override_setting_value(value: &AutoplayThresholdOverride) -> String {
    match value {
...
pub fn parse_unpause_action_mode(value: &str) -> Option<UnpauseActionMode> {
...
pub fn parse_autoplay_min_users_override(value: &str) -> Option<AutoplayThresholdOverride> {
...
mod tests {
    ...
    fn legacy_name_helpers_match_expected_python_labels() {
        assert_eq!(
            privacy_mode_syncplay_name(PrivacyMode::SendHashed),
            "SendHashed"
        );
        assert_eq!(
            unpause_action_mode_syncplay_name(UnpauseActionMode::IfMinUsersReady),
            "IfMinUsersReady"
        );
        assert_eq!(
            autoplay_threshold_override_setting_value(&AutoplayThresholdOverride::Set(3)),
            "3"
        );
    }
