...
pub fn localized_file_differences_prefix(language: Option<&str>) -> &'static str {
    match language {
...
fn localized_file_difference_token(token: &str, language: Option<&str>) -> String {
...
pub fn localized_file_difference_summary(summary: &str, language: Option<&str>) -> String {
    summary
        .split(", ")
        .map(|token| localized_file_difference_token(token, language))
        .collect::<Vec<_>>()
        .join(", ")
}

pub fn localized_file_difference_notification_line(
    summary: &str,
    language: Option<&str>,
) -> String {
    format!(
        "{}: {}",
        localized_file_differences_prefix(language),
        localized_file_difference_summary(summary, language)
    )
}

pub fn next_file_difference_notification_summary(
