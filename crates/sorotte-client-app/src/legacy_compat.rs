...
-> &'static [LegacyConfigurationGetterStartupCompatEntry] {
    ...
    &[
        ...
        LegacyConfigurationGetterStartupCompatEntry {
            ...
            status: Supported,
            note: "clears sorotte.ini stored settings and legacy GUI QSettings stores (PlayerList, MediaBrowseDialog, MainWindow, Interface, MoreSettings)",
        },
        LegacyConfigurationGetterStartupCompatEntry {
            input: "--version",
            status: Supported,
...
-> &'static [LegacyConfigurationGetterIniCompatEntry] {
    ...
    &[
        ...
        LegacyConfigurationGetterIniCompatEntry {
            ...
            status: Supported,
            note: "loaded/persisted as the same headless startup gate as legacy --force-gui-prompt; True halts sorotte-cli unless --no-gui explicitly overrides",
        },
        LegacyConfigurationGetterIniCompatEntry {
