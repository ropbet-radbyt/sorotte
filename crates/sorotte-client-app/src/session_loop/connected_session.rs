...
pub fn connected_session_inbound_post_apply_plan(
...
pub fn connected_session_inbound_post_apply_actions(
...
pub fn connected_session_inbound_apply_plan(
...
pub fn connected_session_protocol_plan(
...
pub fn connected_session_branch_plan(
    event_kind: ConnectedSessionLoopEventKind,
    emitted_runtime_action: bool,
    shared_playlists_enabled: bool,
    ...
    ConnectedSessionBranchPlan {
        ...
        runtime_steps: connected_session_runtime_step_plan(event_kind),
        protocol: connected_session_protocol_plan(
            event_kind,
            emitted_runtime_action,
            shared_playlists_enabled,
        ),
        drain: connected_session_drain_plan(event_kind, diagnostics),
    }
}

pub fn connected_session_event_plan(
    event_kind: ConnectedSessionLoopEventKind,
    ...
    ConnectedSessionEventPlan {
        inbound_post_apply: match event_kind {
            ConnectedSessionLoopEventKind::InboundMessage => {
                Some(connected_session_inbound_post_apply_plan(
...
pub fn connected_session_event_execution_plan(
    event_kind: ConnectedSessionLoopEventKind,
    ...
    ConnectedSessionEventExecutionPlan {
        inbound_apply: match event_kind {
            ConnectedSessionLoopEventKind::InboundMessage => {
                Some(connected_session_inbound_apply_plan(
        ...
        event: connected_session_event_plan(event_kind, inputs.event),
    }
}

pub fn connected_session_inbound_message_event_execution_plan(
    inbound_is_server_hello: bool,
    has_pending_chat_message_on_connect: bool,
    inbound_message_is_state: bool,
...
pub fn connected_session_autoplay_tick_event_execution_plan(
    shared: ConnectedSessionSharedExecutionInputs,
) -> ConnectedSessionEventExecutionPlan {
    connected_session_event_execution_plan(
        ConnectedSessionLoopEventKind::AutoplayTick,
...
pub fn connected_session_player_coordination_tick_event_execution_plan(
    shared: ConnectedSessionSharedExecutionInputs,
) -> ConnectedSessionEventExecutionPlan {
    ConnectedSessionEventExecutionPlan {
        inbound_apply: None,
...
pub fn connected_session_local_input_event_execution_plan(
    emitted_runtime_action: bool,
    shared: ConnectedSessionSharedExecutionInputs,
) -> ConnectedSessionEventExecutionPlan {
    connected_session_event_execution_plan(
...
pub fn connected_session_runtime_step_plan(
    event_kind: ConnectedSessionLoopEventKind,
...
pub fn connected_session_runtime_step_actions(
...
pub fn connected_session_drain_plan(
    event_kind: ConnectedSessionLoopEventKind,
    diagnostics: ConnectedSessionDiagnosticsPlan,
...
pub fn connected_session_drain_actions(
