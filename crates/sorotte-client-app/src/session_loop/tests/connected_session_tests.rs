...
#[test]
fn connected_session_drain_plan_enables_inbound_flushes() {
    let plan = connected_session_drain_plan(
...
#[test]
fn connected_session_drain_plan_specializes_tick_and_local_input() {
    let autoplay_tick_plan = connected_session_drain_plan(
    ...
    let local_input_plan = connected_session_drain_plan(
...
#[test]
fn connected_session_drain_actions_preserves_shared_ordering() {
    let actions = connected_session_drain_actions(ConnectedSessionDrainPlan {
...
#[test]
fn connected_session_drain_actions_omits_disabled_actions() {
    let actions = connected_session_drain_actions(ConnectedSessionDrainPlan {
...
#[test]
fn connected_session_inbound_post_apply_actions_preserves_shared_ordering() {
    let actions =
        connected_session_inbound_post_apply_actions(ConnectedSessionInboundPostApplyPlan {
...
#[test]
fn connected_session_inbound_post_apply_actions_omits_disabled_actions() {
    let actions =
        connected_session_inbound_post_apply_actions(ConnectedSessionInboundPostApplyPlan {
...
#[test]
fn connected_session_runtime_step_plan_matches_inbound_and_tick_policy() {
    let inbound_plan =
        connected_session_runtime_step_plan(ConnectedSessionLoopEventKind::InboundMessage);
    ...
    let tick_plan =
        connected_session_runtime_step_plan(ConnectedSessionLoopEventKind::AutoplayTick);
...
#[test]
fn connected_session_runtime_step_plan_keeps_local_input_minimal() {
    let plan = connected_session_runtime_step_plan(ConnectedSessionLoopEventKind::LocalInput);
...
#[test]
fn connected_session_runtime_step_actions_preserve_execution_order() {
    let actions = connected_session_runtime_step_actions(
...
#[test]
fn connected_session_inbound_post_apply_plan_matches_policy() {
    let full_plan = connected_session_inbound_post_apply_plan(true, true, true);
    ...
    let reduced_plan = connected_session_inbound_post_apply_plan(false, false, false);
...
#[test]
fn connected_session_inbound_apply_plan_specializes_state_messages() {
    assert_eq!(
        connected_session_inbound_apply_plan(true, false),
    ...
    assert_eq!(
        connected_session_inbound_apply_plan(true, true),
        ConnectedSessionInboundApplyPlan {
            reconcile_inbound_state: true,
            apply_message_json_at: false,
            outbound_state_sync_enabled: true,
...
#[test]
fn connected_session_inbound_apply_plan_preserves_non_state_policy() {
    assert_eq!(
        connected_session_inbound_apply_plan(false, false),
        ConnectedSessionInboundApplyPlan {
    ...
    assert_eq!(
        connected_session_inbound_apply_plan(false, true),
        ConnectedSessionInboundApplyPlan {
            reconcile_inbound_state: false,
            apply_message_json_at: true,
            outbound_state_sync_enabled: true,
...
#[test]
fn connected_session_protocol_plan_handles_inbound_playlist_policy() {
    assert_eq!(
        connected_session_protocol_plan(ConnectedSessionLoopEventKind::InboundMessage, false, true,),
    ...
    assert_eq!(
        connected_session_protocol_plan(
            ConnectedSessionLoopEventKind::InboundMessage,
            false,
            false,
        ),
...
#[test]
fn connected_session_protocol_plan_handles_tick_and_local_input() {
    assert_eq!(
        connected_session_protocol_plan(ConnectedSessionLoopEventKind::AutoplayTick, false, true,),
        ConnectedSessionProtocolPlan {
            flush_runtime_protocol_lines: true,
    ...
    assert_eq!(
        connected_session_protocol_plan(ConnectedSessionLoopEventKind::LocalInput, false, true,),
        ConnectedSessionProtocolPlan {
    ...
    assert_eq!(
        connected_session_protocol_plan(ConnectedSessionLoopEventKind::LocalInput, true, true,),
        ConnectedSessionProtocolPlan {
            flush_runtime_protocol_lines: true,
            startup_playlist_disposition: ConnectedSessionStartupPlaylistDisposition::LeavePending,
        }
...
#[test]
fn connected_session_branch_plan_assembles_inbound_policy() {
    assert_eq!(
        connected_session_branch_plan(
            ConnectedSessionLoopEventKind::InboundMessage,
            false,
            true,
            ConnectedSessionDiagnosticsPlan {
        ...
        ConnectedSessionBranchPlan {
            ...
            runtime_steps: connected_session_runtime_step_plan(
                ConnectedSessionLoopEventKind::InboundMessage,
            ),
            protocol: connected_session_protocol_plan(
                ConnectedSessionLoopEventKind::InboundMessage,
                false,
                true,
            ),
            drain: connected_session_drain_plan(
                ConnectedSessionLoopEventKind::InboundMessage,
                ConnectedSessionDiagnosticsPlan {
                    log_player_telemetry: false,
                    log_player_drift: true,
...
#[test]
fn connected_session_branch_plan_assembles_local_input_policy() {
    assert_eq!(
        connected_session_branch_plan(
            ConnectedSessionLoopEventKind::LocalInput,
            true,
...
#[test]
fn connected_session_event_plan_assembles_inbound_post_apply_and_branch() {
    ...
    assert_eq!(
        ...
        ConnectedSessionEventPlan {
            inbound_post_apply: Some(connected_session_inbound_post_apply_plan(true, true, true),),
            branch: connected_session_branch_plan(
                ConnectedSessionLoopEventKind::InboundMessage,
                false,
                true,
                diagnostics,
...
#[test]
fn connected_session_event_plan_keeps_non_inbound_post_apply_empty() {
    let diagnostics = ConnectedSessionDiagnosticsPlan {
        log_player_telemetry: true,
        log_player_drift: false,
        reconnect_correction_diagnostics_format: None,
...
#[test]
fn connected_session_event_execution_plan_combines_inbound_apply_and_event() {
    ...
    assert_eq!(
        connected_session_event_execution_plan(
            ConnectedSessionLoopEventKind::InboundMessage,
        ...
        ConnectedSessionEventExecutionPlan {
            inbound_apply: Some(connected_session_inbound_apply_plan(true, false),),
            event: connected_session_event_plan(
                ConnectedSessionLoopEventKind::InboundMessage,
                event_inputs,
            ),
        }
...
#[test]
fn connected_session_event_execution_plan_keeps_non_inbound_apply_empty() {
    let event_inputs = ConnectedSessionEventPlanInputs {
        emitted_runtime_action: true,
        inbound_is_server_hello: false,
...
#[test]
fn connected_session_inbound_message_event_execution_plan_packs_inputs() {
    ...
    assert_eq!(
        connected_session_inbound_message_event_execution_plan(true, true, true, shared,),
        connected_session_event_execution_plan(
            ConnectedSessionLoopEventKind::InboundMessage,
            ConnectedSessionEventExecutionPlanInputs {
...
#[test]
fn connected_session_autoplay_tick_event_execution_plan_packs_inputs() {
    let shared = ConnectedSessionSharedExecutionInputs {
        shared_playlists_enabled: true,
        diagnostics: ConnectedSessionDiagnosticsPlan {
            log_player_telemetry: true,
    ...
    assert_eq!(
        connected_session_autoplay_tick_event_execution_plan(shared),
        connected_session_event_execution_plan(
            ConnectedSessionLoopEventKind::AutoplayTick,
            ConnectedSessionEventExecutionPlanInputs {
                event: ConnectedSessionEventPlanInputs {
...
#[test]
fn connected_session_player_coordination_tick_event_execution_plan_packs_inputs() {
    let shared = ConnectedSessionSharedExecutionInputs {
        shared_playlists_enabled: true,
        diagnostics: ConnectedSessionDiagnosticsPlan {
            log_player_telemetry: true,
    ...
    let plan = connected_session_player_coordination_tick_event_execution_plan(shared);
...
#[test]
fn connected_session_local_input_event_execution_plan_packs_inputs() {
    let shared = ConnectedSessionSharedExecutionInputs {
    ...
    assert_eq!(
        connected_session_local_input_event_execution_plan(true, shared),
        connected_session_event_execution_plan(
            ConnectedSessionLoopEventKind::LocalInput,
            ConnectedSessionEventExecutionPlanInputs {
                event: ConnectedSessionEventPlanInputs {
