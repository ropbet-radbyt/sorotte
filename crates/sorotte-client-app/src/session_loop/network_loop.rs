...
pub fn client_network_loop_event_plan(
...
pub fn client_network_loop_attempt_plan(
...
pub fn client_network_loop_attempt_plan_for_connect_failure() -> ClientNetworkLoopAttemptPlan {
    client_network_loop_attempt_plan(ClientNetworkLoopAttemptOutcomeKind::ConnectFailed)
}

pub fn client_network_loop_attempt_plan_for_connected_session_exit(
    exit_kind: ConnectedSessionOuterLoopExitKind,
) -> ClientNetworkLoopAttemptPlan {
    client_network_loop_attempt_plan(match exit_kind {
...
pub fn client_network_loop_attempt_plan_for_source(
    ...
    match source {
        ...
        ClientNetworkLoopAttemptSource::ConnectedSession(exit_kind) => {
            client_network_loop_attempt_plan_for_connected_session_exit(exit_kind)
        }
    }
}

pub fn client_network_loop_attempt_execution_plan_for_source(
    source: ClientNetworkLoopAttemptSource,
) -> ClientNetworkLoopAttemptExecutionPlan {
    ClientNetworkLoopAttemptExecutionPlan {
        source,
        attempt_plan: client_network_loop_attempt_plan_for_source(source),
    }
}

pub fn client_network_loop_attempt_execution_plan_for_connect_failure()
-> ClientNetworkLoopAttemptExecutionPlan {
...
pub fn client_network_loop_attempt_execution_plan_for_connected_session_exit(
    exit_kind: ConnectedSessionOuterLoopExitKind,
) -> ClientNetworkLoopAttemptExecutionPlan {
    client_network_loop_attempt_execution_plan_for_source(
        ClientNetworkLoopAttemptSource::ConnectedSession(exit_kind),
...
pub fn client_network_loop_execution_outcome(
...
pub fn client_network_loop_attempt_disposition(
...
pub fn client_network_loop_attempt_disposition_for_execution_plan(
    execution_plan: ClientNetworkLoopAttemptExecutionPlan,
    outcome: ClientNetworkLoopExecutionOutcome,
) -> ClientNetworkLoopAttemptDisposition {
    let derived_attempt_plan = client_network_loop_attempt_plan_for_source(execution_plan.source);
    debug_assert_eq!(execution_plan.attempt_plan, derived_attempt_plan);
    client_network_loop_attempt_disposition(derived_attempt_plan, outcome)
}

pub fn client_network_loop_reconnect_exhausted_error_action(
...
pub fn client_reconnect_backoff_plan(
    current_retries: u32,
    stop_requested: bool,
...
pub fn client_network_loop_startup_plan(
    inputs: ClientNetworkLoopStartupPlanInputs<'_>,
) -> ClientNetworkLoopStartupPlan {
    ClientNetworkLoopStartupPlan {
        apply_explicit_mpv_ipc_startup: inputs.has_argument_overrides,
