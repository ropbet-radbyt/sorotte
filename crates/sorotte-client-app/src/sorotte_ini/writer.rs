...
pub fn upsert_sorotte_ini_stored_client_settings_mvp(
    existing_contents: &str,
    settings: &StoredClientSettingsMvp,
) -> String {
    upsert_sorotte_ini_stored_client_settings_mvp_with_plex_identity_clear(
        existing_contents,
        settings,
        false,
    )
...
pub fn upsert_sorotte_ini_stored_client_settings_mvp_clearing_plex_identity(
    existing_contents: &str,
    settings: &StoredClientSettingsMvp,
) -> String {
    upsert_sorotte_ini_stored_client_settings_mvp_with_plex_identity_clear(
...
fn upsert_sorotte_ini_stored_client_settings_mvp_with_plex_identity_clear(
    existing_contents: &str,
    settings: &StoredClientSettingsMvp,
