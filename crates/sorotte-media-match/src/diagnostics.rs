...
fn summarize_record_v3_diagnostics_with_report(
    ...
    MediaMatchV3DiagnosticSummary {
        ...
        sampled_ffmpeg_window_strategy: audio_stream
            .and_then(|stream| stream.sampled_ffmpeg_window_strategy.clone()),
        sampled_windows_planned: audio_stream.and_then(|stream| stream.sampled_windows_planned),
        sampled_stop_reason: audio_stream.and_then(|stream| stream.sampled_stop_reason.clone()),
        provisional_landmark_count: audio_stream
        ...
        mkv_clusters_scanned: audio_stream.and_then(|stream| stream.mkv_clusters_scanned),
        mkv_cluster_bytes_read: audio_stream.and_then(|stream| stream.mkv_cluster_bytes_read),
        mkv_audio_block_bytes_read: audio_stream
            .and_then(|stream| stream.mkv_audio_block_bytes_read),
        mkv_coalesced_range_bytes: audio_stream.and_then(|stream| stream.mkv_coalesced_range_bytes),
        mkv_estimated_savings_vs_current: audio_stream
            .and_then(|stream| stream.mkv_estimated_savings_vs_current),
        mkv_fallback_reason: audio_stream.and_then(|stream| stream.mkv_fallback_reason.clone()),
...
pub fn summarize_decision_v3_diagnostics(
    ...
    MediaMatchV3DiagnosticSummary {
        ...
        sampled_ffmpeg_window_strategy: None,
        sampled_windows_planned: None,
        ...
        mkv_clusters_scanned: None,
        mkv_cluster_bytes_read: None,
        mkv_audio_block_bytes_read: None,
        mkv_coalesced_range_bytes: None,
        mkv_estimated_savings_vs_current: None,
        mkv_fallback_reason: None,
        streamed_bytes: None,
