...
fn gui_client_core_chat_tcp_bootstrap_overrides_settings_enable_chat_and_seed_connection() {
    let settings = super::super::gui_startup_settings_from_lookup_with(
        |name| match name {
            ...
            "SOROTTE_CLIENT_HOST" => Some("2001:db8::1".to_owned()),
            "SOROTTE_CLIENT_PORT" => Some("9000".to_owned()),
            "SOROTTE_CLIENT_USERNAME" => Some("gui-user".to_owned()),
            "SOROTTE_CLIENT_ROOM" => Some("gui-room".to_owned()),
            _ => None,
        },
