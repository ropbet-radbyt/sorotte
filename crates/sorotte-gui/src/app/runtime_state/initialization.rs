...
use crate::app::runtime_localization::normalized_runtime_language_tag_or_default;
    ...
    pub(in crate::app) fn from_stored_settings(settings: &StoredClientSettings) -> Self {
        ...
        let mut state = Self {
            session: session::RuntimeView {
                ...
                public_servers: PublicServerBrowserShellState::from_stored_settings(
                    &shell_settings,
                ),
            },
            ...
            updates: updates::RuntimeView {
                ...
                policy: updates::RuntimePolicy {
                    ...
                    language: normalized_runtime_language_tag_or_default(
                        shell_settings.language.as_deref(),
                    )
                    .to_owned(),
                    channel: shell_settings
                        .update_channel
                        .as_deref()
