...
pub(super) fn localize_exact_message(message: &str, language: Option<&str>) -> Option<String> {
    let localized = match strip_period(message) {
        ...
        "Slowing playback to synchronize with the room" => localized_literal(
            language,
            "Slowing playback to synchronize with the room",
            "Wiedergabe wird verlangsamt, um mit dem Raum zu synchronisieren",
            "Ralentizando la reproduccion para sincronizar con la sala",
            "Malrapidigante la ludadon por sinkronigi kun la cxambro",
            "Hidastetaan toistoa huoneen kanssa synkronoimiseksi",
            "Ralentissement de la lecture pour synchroniser avec la salle",
            "Rallentamento della riproduzione per sincronizzarsi con la stanza",
            "Diminuindo a velocidade da reproducao para sincronizar com a sala",
            "Odayla esitlemek icin oynatma yavaslatiliyor",
            "Vosproizvedenie zamedliaetsia dlia sinkhronizatsii s komnatoi",
            "Zhengzai jiansu bofang yi yu fangjian tongbu",
            "bang-gwa dong-gihwahagi wihae jaesaeng sogdoreul neujchuneun jung",
        ),
        "Restoring normal playback speed" => localized_literal(
            language,
            "Restoring normal playback speed",
            "Normale Wiedergabegeschwindigkeit wird wiederhergestellt",
            "Restaurando la velocidad normal de reproduccion",
            "Restarigante normalan ludrapidecon",
            "Palautetaan normaali toistonopeus",
            "Retour a la vitesse de lecture normale",
            "Ripristino della normale velocita di riproduzione",
            "Restaurando a velocidade normal de reproducao",
            "Normal oynatma hizi geri yukleniyor",
            "Vosstanavlivaetsia normalnaia skorost vosproizvedeniia",
            "Zhengzai huifu zhengchang bofang sudu",
            "jeongsang jaesaeng sogdoreul bokguhaneun jung",
        ),
        ...
        "Sorotte media directories have been updated" => localized_literal(
            language,
            "Sorotte media directories have been updated",
            "Sorotte-Medienverzeichnisse wurden aktualisiert",
            "Los directorios multimedia de Sorotte se han actualizado",
            "La amaskomunikilaj dosierujoj de Sorotte estis gxisdatigitaj",
            "Sorotten mediakansiot on paivitetty",
            "Les repertoires multimedias Sorotte ont ete mis a jour",
            "Le directory multimediali di Sorotte sono state aggiornate",
            "Os diretorios de midia do Sorotte foram atualizados",
            "Sorotte medya dizinleri guncellendi",
            "Katalogi media Sorotte obnovleny",
            "Sorotte meiti mulu yi gengxin",
            "Sorotte midieo diregtoriga eobdeiteu-doeeotseumnida",
        ),
