...
pub fn run_sorotte_gui_semantic_output(
    ...
    run_sorotte_gui_semantic_report(source).map(|report| report.render(format))
}

pub fn run_sorotte_gui_semantic_report_from_script(
    script: &str,
) -> Result<GuiSemanticScenarioReport, String> {
    run_sorotte_gui_semantic_report(GuiSemanticScenarioSource::InlineScript(script.to_owned()))
}

pub fn run_sorotte_gui_semantic_report_from_script_path(
    path: &str,
) -> Result<GuiSemanticScenarioReport, String> {
    run_sorotte_gui_semantic_report(GuiSemanticScenarioSource::ScriptPath(path.to_owned()))
}

pub(crate) fn run_sorotte_gui_semantic_cli_from_args<I, S>(
    args: I,
...
where
    ...
    S: AsRef<str>,
{
    cli::run_sorotte_gui_semantic_cli_from_args_impl(args)
}
...
pub(crate) fn run_sorotte_gui_semantic_report_from_lookup<F>(
    lookup: F,
) -> Result<Option<GuiSemanticScenarioReport>, String>
where
    F: Fn(&str) -> Option<String>,
...
pub(crate) fn run_sorotte_gui_semantic_cli_from_lookup<F>(
    lookup: F,
) -> Result<Option<String>, String>
where
    F: Fn(&str) -> Option<String>,
...
pub(crate) fn run_sorotte_gui_semantic_report_from_env()
-> Result<Option<GuiSemanticScenarioReport>, String> {
    run_sorotte_gui_semantic_report_from_lookup(cli::semantic_env_trimmed)
}

pub(crate) fn run_sorotte_gui_semantic_cli_from_env() -> Result<Option<String>, String> {
    run_sorotte_gui_semantic_cli_from_lookup(cli::semantic_env_trimmed)
}
