...
impl GuiPersistedConfigRuntimeOwner {
    ...
    pub(super) fn handle_complete_configuration_save_request(
        ...
        handle: &GuiQueuedRuntimeBridgeHandle,
        projected_state: &mut SyncplayGuiShellAppState,
        settings: syncplay_client_app::app_boundary::state::StoredClientSettingsMvp,
    ) -> bool {
    ...
    pub(super) fn handle_complete_configuration_reload_request(
        ...
        handle: &GuiQueuedRuntimeBridgeHandle,
        projected_state: &mut SyncplayGuiShellAppState,
        fallback_settings: syncplay_client_app::app_boundary::state::StoredClientSettingsMvp,
    ) -> bool {
        let Some(path) = self.config_path.as_ref() else {
            Self::push_actions_and_project(
                handle,
