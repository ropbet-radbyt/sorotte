#[path = "semantic_smoke/catalog.rs"]
mod catalog;
#[path = "semantic_smoke/cli.rs"]
mod cli;
#[path = "semantic_smoke/custom_flows.rs"]
mod custom_flows;
#[path = "semantic_smoke/external_script.rs"]
mod external_script;
...
where
    F: Fn(&str) -> Option<String>,
{
    cli::gui_semantic_scenario_script_path_from_lookup(lookup)
}
