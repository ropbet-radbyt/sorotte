...
#[path = "syncplay-gui-native-smoke/native_smoke_accessibility.rs"]
mod native_smoke_accessibility;
#[path = "syncplay-gui-native-smoke/native_smoke_cli.rs"]
mod native_smoke_cli;
#[path = "syncplay-gui-native-smoke/native_smoke_setup.rs"]
