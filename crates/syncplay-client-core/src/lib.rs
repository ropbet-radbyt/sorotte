...
impl ClientSession {
    ...
    fn normalized_local_seek_target(&self, target_position: f64, now_seconds: f64) -> Option<f64> {
    ...
    fn reconcile_state_and_build_response_with_local_state_change_override(
        &mut self,
        inbound_state: StatePayload,
        local_position: f64,
        local_paused: bool,
    ...
    fn determine_local_state_change_with_global_playstate_override(
        &self,
        local_paused: bool,
        local_position: f64,
...
mod tests {
    ...
    fn client_runtime_set_playlist_index_allows_default_trusted_youtube_domain() {
        ...
        assert!(playlist_index.user.is_none());
        let ProtocolMessage::State(state_message) = &runtime.control().outbound_messages()[1]
        else {
