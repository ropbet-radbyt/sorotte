...
pub(super) fn behavior_overrides_from_env() -> ClientBehaviorOverrides {
    ClientBehaviorOverrides {
        pause_on_leave: env_flag_override("SOROTTE_CLIENT_PAUSE_ON_LEAVE"),
        loop_at_end_of_playlist: env_flag_override("SOROTTE_CLIENT_LOOP_AT_END_OF_PLAYLIST"),
        loop_single_files: env_flag_override("SOROTTE_CLIENT_LOOP_SINGLE_FILES"),
        only_switch_to_trusted_domains: env_flag_override(
            "SOROTTE_CLIENT_ONLY_SWITCH_TO_TRUSTED_DOMAINS",
        ),
        trusted_domains: env_string_list("SOROTTE_CLIENT_TRUSTED_DOMAINS"),
        reconnect_state_restore_auto_correct: env_flag_override(
            "SOROTTE_CLIENT_RECONNECT_RESTORE_AUTOCORRECT",
        ),
        ...
        reconnect_state_restore_correction_retry_max_attempts: env_u32(
            "SOROTTE_CLIENT_RECONNECT_RESTORE_CORRECTION_RETRY_MAX_ATTEMPTS",
        ),
        reconnect_state_restore_correction_retry_cooldown_ticks: env_u32(
            "SOROTTE_CLIENT_RECONNECT_RESTORE_CORRECTION_RETRY_COOLDOWN_TICKS",
        ),
        reconnect_state_restore_correction_retry_exponential_backoff: env_flag_override(
            "SOROTTE_CLIENT_RECONNECT_RESTORE_CORRECTION_RETRY_EXPONENTIAL_BACKOFF",
        ),
        reconnect_state_restore_correction_retry_max_cooldown_ticks: env_u32(
            "SOROTTE_CLIENT_RECONNECT_RESTORE_CORRECTION_RETRY_MAX_COOLDOWN_TICKS",
        ),
        reconnect_state_restore_correction_retry_adaptive_cycle_backoff: env_flag_override(
            "SOROTTE_CLIENT_RECONNECT_RESTORE_CORRECTION_RETRY_ADAPTIVE_CYCLE_BACKOFF",
        ),
        reconnect_state_restore_correction_retry_adaptive_cycle_budget: env_flag_override(
            "SOROTTE_CLIENT_RECONNECT_RESTORE_CORRECTION_RETRY_ADAPTIVE_CYCLE_BUDGET",
        ),
        reconnect_state_restore_correction_retry_adaptive_cycle_budget_min_attempts: env_u32(
            "SOROTTE_CLIENT_RECONNECT_RESTORE_CORRECTION_RETRY_ADAPTIVE_CYCLE_BUDGET_MIN_ATTEMPTS",
        ),
        reconnect_state_restore_correction_disable_after_mismatch_cycles: env_u32(
            "SOROTTE_CLIENT_RECONNECT_RESTORE_CORRECTION_DISABLE_AFTER_MISMATCHES",
        ),
        reconnect_state_restore_correction_disable_after_mismatch_decay_on_success: env_u32(
            "SOROTTE_CLIENT_RECONNECT_RESTORE_CORRECTION_DISABLE_AFTER_MISMATCH_DECAY_ON_SUCCESS",
        ),
        reconnect_state_restore_correction_recovery_cooldown_reconnect_cycles: env_u32(
            "SOROTTE_CLIENT_RECONNECT_RESTORE_CORRECTION_RECOVERY_COOLDOWN_RECONNECT_CYCLES",
        ),
    }
}
...
pub(super) fn chat_policy_overrides_from_env() -> ChatPolicyOverrides {
    ChatPolicyOverrides {
        max_chat_message_length: env_usize("SOROTTE_CLIENT_CHAT_MAX_LENGTH"),
        apply_server_max_chat_message_length: env_flag_override(
            "SOROTTE_CLIENT_APPLY_SERVER_CHAT_MAX_LENGTH",
        ),
    }
}
