...
fn reconnect_correction_diagnostics_format_from_env_prefers_json_when_enabled() {
    let key_text = "SOROTTE_CLIENT_LOG_RECONNECT_CORRECTION_DIAGNOSTICS";
    let key_json = "SOROTTE_CLIENT_LOG_RECONNECT_CORRECTION_DIAGNOSTICS_JSON";
...
fn reconnect_correction_diagnostics_alert_thresholds_from_env_parses_values() {
    let key_failures = "SOROTTE_CLIENT_RECONNECT_CORRECTION_ALERT_ACTION_FAILURES_DELTA_THRESHOLD";
    let key_retry = "SOROTTE_CLIENT_RECONNECT_CORRECTION_ALERT_RETRY_EXHAUSTIONS_DELTA_THRESHOLD";
    let key_mismatch =
