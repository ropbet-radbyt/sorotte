...
use crate::constants::SYNCPLAYINTF_PROTOCOL;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum SyncplayOsdKind {
    Notification,
    Alert,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SyncplayUiSettings {
    pub show_osd: bool,
...
impl Default for SyncplayUiSettings {
    fn default() -> Self {
        Self {
            show_osd: true,
...
pub(crate) fn sanitize_syncplay_script_message_text(message: &str) -> String {
    message
        .replace("\r\n", "\n")
        .replace('\r', "\n")
        .replace('\n', "\\n")
