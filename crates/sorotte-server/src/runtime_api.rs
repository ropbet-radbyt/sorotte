...
impl ServerRuntime {
    ...
    pub fn with_room_password_salt(salt: impl Into<SecretValue>) -> Self {
        ...
        Self {
            ...
            client_participant_status: BTreeMap::new(),
            client_participant_status_last_sequence: BTreeMap::new(),
            room_participant_status_scopes: BTreeMap::new(),
            room_participant_status_snapshot_revisions: BTreeMap::new(),
            participant_status_snapshot_cache: BTreeMap::new(),
