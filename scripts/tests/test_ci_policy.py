        ...
        self.assertEqual(
            ...
            },
            {
                ...
                "shard": [
                    ...
                    {
                        "id": "cli-stored-config",
                        "owner": "client-configuration",
                        "package": "sorotte-cli",
                        "files": ["crates/sorotte-cli/src/stored_settings/config_apply.rs"],
                        "mutant_filter": "",
                        "test_target": "lib",
                        "test_filter": "stored_settings::config_apply::",
                        "jobs": 2,
                        "timeout_seconds": 60,
                        "build_timeout_seconds": 120,
                        "minimum_viable_kill_percent": "100.00",
                ...
                "accepted_unviable": [
                    {
                        "id": "cli-stored-config-let-chain-or",
                        "expected_count": 6,
                        "shard": "cli-stored-config",
                        "file": "crates/sorotte-cli/src/stored_settings/config_apply.rs",
                        "function": "apply_stored_client_settings",
                        "return_type": "",
                        "genre": "BinaryOperator",
                        "replacement": "||",
                        "reason": "cargo-mutants replaces && with || in six let-chain conditions; Rust rejects || in a let chain, confirmed by compiling all six generated replacements",
