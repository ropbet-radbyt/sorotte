...
- The GUI is real and test-covered, and saved-config connection plus the Python-style room/user/file browser plus shared-playlist file opening/import are now runtime-backed; the major room/media/playback affordances no longer advertise config-only projections as working paths.
